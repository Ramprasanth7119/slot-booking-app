  ...
  return (
    <section className="mx-auto max-w-4xl space-y-8 py-8 sm:py-12">
      <div className="space-y-4">
        <p className="text-xs font-semibold uppercase tracking-[0.34em] text-sky-300/80">Admin / Create Slot</p>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl space-y-3">
            ...
            <p className="text-sm leading-7 text-zinc-400 sm:text-base">
              Define your availability by creating time slots. Slots appear on the public site immediately after creation.
            </p>
          </div>
