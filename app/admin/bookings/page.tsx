        ...
        <div className="flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/[0.02] p-4 lg:flex-row lg:items-center">
          <div className="flex flex-1 flex-col gap-2">
            ...
            <input
              ...
              className="h-10 rounded-xl border border-black/10 bg-white/50 px-4 text-sm text-foreground focus:border-sky-400/50 focus:outline-none focus:ring-1 focus:ring-sky-400/50 dark:border-white/10 dark:bg-white/[0.05] dark:text-white"
            />
          </div>
          <div className="flex flex-col gap-2">
            ...
            <select
              ...
              className="h-10 rounded-xl border border-black/10 bg-white/50 px-4 text-sm text-foreground focus:border-sky-400/50 focus:outline-none focus:ring-1 focus:ring-sky-400/50 dark:border-white/10 dark:bg-zinc-900 dark:text-white sm:w-80"
            >
